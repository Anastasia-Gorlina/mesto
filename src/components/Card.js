export class Card {
    ...
    _handleLikeCard = () => {
        if (this._likeButtonElement.classList.contains('element__vector_active')) {
    ...
    _toggleLikeColorAndCounter = (card) => {
        this._likeButtonElement.classList.toggle('element__vector_active');
    ...
    createCard() {
        ...
        if (this._likes.some((item) => item._id === this._user._id)) this._likeButtonElement.classList.add('element__vector_active');
